...
const registerSchema = Yup.object().shape({
  name: Yup.string()
    ...
    .matches(
      /^[А-ЯЁ][а-яё]+$/,
      'Имя должно быть на русском и с заглавной буквы'
    )
    .test(
      'no-profanity',
      'Имя не должно содержать нецензурных слов',
  ...
  surname: Yup.string()
    ...
    .matches(
      /^[А-ЯЁ][а-яё]+$/,
      'Фамилия должна быть на русском и с заглавной буквы'
    )
    .test(
      'no-profanity',
      'Фамилия не должна содержать нецензурных слов',
      (value) => !leoProfanity.check(value)
    ),
  phone: Yup.string()
