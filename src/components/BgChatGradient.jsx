...
export default function BgChatGradient({ aggregated, children }) {
  ...
  useEffect(() => {
    if (currentGradient && currentGradient !== displayedGradient) {
      ...
      const timer = setTimeout(() => {
        ...
        api.start({ opacity: 0 }); // плавно исчезает
      }, 1200);
  ...
  const layerStyle = useMemo(
    () => ({
      ...
      filter: "blur(20px)", // 💫 добавляем мягкий фон
      transition: "filter 1.2s ease, background-image 1.2s ease", // 🔥 плавность
      animation:
    ...
    >
      <div
        ...
        style={{
          ...
          mixBlendMode: "screen", // 🌈 режим наложения
          position: "absolute",
          top: 0,
          left: 0,
          right: 0,
      ...
      <animated.div
        ...
        style={{
          ...
          mixBlendMode: "overlay", // 🌀 наложение другого характера
          position: "absolute",
          top: 0,
          left: 0,
          right: 0,
